...
class CustomFittedTextFieldContainer extends StatefulWidget {
  ...
  const CustomFittedTextFieldContainer({
    Key key,
    @required this.child,
    this.builder,
  ...
  @override
  _CustomFittedTextFieldContainerState createState() =>
      _CustomFittedTextFieldContainerState();
}

class _CustomFittedTextFieldContainerState extends State<CustomFittedTextFieldContainer> {
